  ...
  return (
    <div className="space-y-8">
      ...
      <section className="grid gap-4 md:grid-cols-4">
        {[
          { label: 'Pending', value: stats.pending, color: '#F59E0B', text: 'text-amber-600', iconName: 'hourglass-half' },
          { label: 'Confirmed', value: stats.confirmed, color: '#059669', text: 'text-emerald-600', iconName: 'clipboard-check' },
          { label: 'Shipped', value: stats.shipped, color: '#7C3AED', text: 'text-violet-600', iconName: 'truck-fast' },
          { label: 'Received', value: stats.received, color: '#10B981', text: 'text-emerald-600', iconName: 'box-open' },
        ].map((item, index) => (
