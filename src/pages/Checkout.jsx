        ...
        <Reveal className="panel space-y-5 p-6 lg:col-span-2">
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            <div className="sm:col-span-2">
              ...
              <input value={form.name} readOnly aria-readonly="true" className="w-full cursor-not-allowed rounded-lg border border-slate-300 bg-slate-100 px-4 py-2 text-sm text-slate-600" />
            </div>
            <div>
              <label className="mb-1.5 block text-sm font-medium text-slate-700">Email</label>
              <input type="email" value={form.email} readOnly aria-readonly="true" className="w-full cursor-not-allowed rounded-lg border border-slate-300 bg-slate-100 px-4 py-2 text-sm text-slate-600" />
            </div>
            <div>
