  ...
  return (
    <div className="fixed inset-0 bg-slate-900/60 backdrop-blur-sm flex items-center justify-center z-[9999] p-4">
      <div className="bg-white w-full max-w-md rounded-[2rem] border border-border shadow-2xl overflow-hidden text-foreground">
        <div className="p-6 border-b border-primary/20 bg-primary flex justify-between items-center">
          <div>
            <h2 className="text-xl font-bold text-white">Record Same-Day Stock Log</h2>
            <p className="text-xs text-emerald-100/85 mt-1">{medicine.medicine_name} ({medicine.medicine_id})</p>
          </div>
          <button onClick={onClose} className="text-emerald-100 hover:text-white text-sm font-semibold">Close</button>
        </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div>
                ...
                <input
                  ...
                  className="mt-2 w-full rounded-2xl border border-slate-200 bg-slate-50 px-4 py-3 text-slate-900 outline-none transition focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500/20"
                />
              ...
              <div className="pt-2 flex flex-col gap-3 sm:flex-row sm:justify-end">
                ...
                <button
                  type="submit"
                  disabled={submitting}
                  className="rounded-2xl bg-emerald-600 px-5 py-3 text-sm font-semibold text-white hover:bg-emerald-700 disabled:opacity-50 w-full sm:w-auto"
                >
