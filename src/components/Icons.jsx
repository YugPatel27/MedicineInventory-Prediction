...
export const ShoppingCart = (props) => (
  <SvgWrapper {...props}>
    ...
    <path d="M2.5 3h2l2.6 12.4a2 2 0 002 1.6h8.4a2 2 0 002-1.6L21.5 7H6" />
  </SvgWrapper>
);
...
export const MessageCircle = (props) => (
  <SvgWrapper {...props}>
    <path d="M21 12a8.5 8.5 0 01-12.4 7.5L3 21l1.6-5.4A8.5 8.5 0 1121 12z" />
  </SvgWrapper>
);
...
export const UserCircle = (props) => (
  <SvgWrapper {...props}>
    ...
    <path d="M6.2 18.2a6 6 0 0111.6 0" />
  </SvgWrapper>
);
